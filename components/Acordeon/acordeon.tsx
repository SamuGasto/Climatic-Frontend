...
export default function Acordeon() {
  return (
    <Accordion variant="splitted">
      ...
      >
        Se utilizan datos con resolución horaria y grilla de 0.25°x0.25° del
        reanálisis ERA5, tanto de niveles superficiales como niveles de presión.
        Climatic permite seleccionar un conjunto de variables de ERA5 que son
      ...
      >
        ...
        estado real de la atmósfera en un tiempo determinado y con la mayor
        precisión posible. ERA5 es constantemente actualizado por el European
        Centre for Medium-Range Weather Forecasts (ECMWF,
        https://www.ecmwf.int/en/about), abarcando entre el año 1950 hasta el
        presente.
      </AccordionItem>
      <AccordionItem
        key="3"
      ...
      >
        ...
        (https://doi.org/10.24381/cds.143582cf). Climatic sin embargo, utiliza
        la versión Analysis-Ready, Cloud-Optimized (ARCO) disponible a través de
        Google Cloud Store
        (https://cloud.google.com/storage/docs/public-datasets/era5?hl=es-419)
      </AccordionItem>
      <AccordionItem
        key="4"
