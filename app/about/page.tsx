...
export default function About() {
  return (
    <div className="justify-items-center -mt-10">
      <h1 className="text-center text-4xl font-bold mb-2 mt-10">
        Sobre Nosotros
      </h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-y-12 justify-items-center md:mx-72 mt-4 mb-24">
        <CardMember
